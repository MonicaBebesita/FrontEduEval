...
@Component({
  standalone: true,
  selector: 'app-ver-competencia-asignatura',
    ...
    <div class="container mt-5">
      <div class="row">
        ...
        <div class="col-md-7">
          ...
          <div *ngIf="vinculadas.length">
            <h5 class="mt-4">Competencias de Programa Vinculadas</h5>
            <ul class="list-group">
              <li *ngFor="let v of vinculadas" class="list-group-item">
                {{ v.nombre }}
              </li>
            </ul>
          </div>
...
export class VerCompetenciaAsignaturaComponent implements OnInit {
  ...
  competenciasPrograma = [
    ...
    { id: 11, nombre: 'Pensamiento lógico' },
  ...
  ngOnInit(): void {
    this.route.paramMap.subscribe((params) => {
      ...
      if (this.competencia?.vinculadas) {
        this.vinculadas = this.competenciasPrograma.filter(cp =>
          this.competencia.vinculadas.includes(cp.id)
        );
      }
    });
  }
